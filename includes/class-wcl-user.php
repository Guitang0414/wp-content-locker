                ...
                <div style="margin-bottom: 30px;">
                    ...
                    <div style="background-color: #f2f2f2; border: 2px solid #000; padding: 25px; margin: 30px 0;">
                        ...
                        <ul style="padding-left: 20px; margin-bottom: 0; color: #000; line-height: 1.5;">
                            <li style="margin-bottom: 10px;">' . sprintf(__('Your payment method will be automatically charged <strong>%s every month</strong> (or year depending on your plan).', 'wp-content-locker'), esc_html($data['amount'])) . '</li>
